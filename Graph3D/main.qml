...
ApplicationWindow {
	...
	Pane {
		...
		Scatter3D {
			...
			measureFps: true
			aspectRatio: 1.0
			selectionMode: Scatter3D.SelectionItem
	...
	Pane {
		...
		ComboBox {
			...
			height: 50
			currentIndex: 0
			model: ["LINEAR", "PATH_XZ_ARC_Y_LINEAR", "PATH_XZ_ARC_Y_SINUS", "PATH_XZ_CIRCLE_45_DEG"]
		}
		...
		Button {
			...
			onClicked: {
				...
				var x0 = beginPointX.text
				var y0 = beginPointY.text
				var z0 = beginPointZ.text

				var x1 = endPointX.text
				var y1 = endPointY.text
				var z1 = endPointZ.text
